...
<tr class="${selectedId === p.id ? "active-row" : ""}" 
  ...
  <td style="text-align:center;">${p.productImage ? '<span style="color:var(--success-text);font-weight:bold;">✓</span>' : '<span style="color:var(--danger-text);">✗</span>'}</td>
  <td style="text-align:center;">${p.annotatedImage ? '<span style="color:var(--success-text);font-weight:bold;">✓</span>' : '<span style="color:var(--text3);">—</span>'}</td>
  <td style="text-align:center;">${(p.drawings || []).length > 0 ? `<span style="color:var(--success-text);font-weight:bold;">${p.drawings.length}</span>` : '<span style="color:var(--text3);">—</span>'}</td>
  <td style="text-align:center;">${(p.swatchImages || []).some(s => s) ? '<span style="color:var(--success-text);font-weight:bold;">✓</span>' : '<span style="color:var(--text3);">—</span>'}</td>
